...
namespace AutoLead
{
	public class Form1 : Form
	{
		...
		{
			//Form1.DisplayClass121_0 variable;
			dynamic vip72Chung;
			DateTime now;
			//Form1.DisplayClass121_3 variable1;
			MethodInvoker methodInvoker;
			Uri uri;
			string value = null;
			string str = null;
			//Form1.DisplayClass121_11 variable2;
			bool flag;
			bool flag1;
			bool @checked;
		...
		Label4:
            ...
            //goto Label2;
            MessageBox.Show("No Label2 to goto line 2300!", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
        Label5:
			if (checked1)
			{
		...
		Label10:
            ...
            //goto Label8;
            MessageBox.Show("No Label8 to goto line 2340!", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
        Label12:
			this.vipacc.limited = true;
			this.listView3.Invoke(new MethodInvoker(() => {
				this.listView3.Items[this.listvipacc.IndexOf(this.vipacc)].BackColor = Color.Red;
            ...
            //goto Label15;
            MessageBox.Show("No Label15 to goto line 2348!", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
        Label13:            
			if (str == "timeout")
			{
                //goto Label15;
                MessageBox.Show("No Lable15 to goto line 2353!", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
			else
			{
				...
				this.curip = this.currentvipip;
                //goto Label8;
                MessageBox.Show("No Lable8 to goto line 2361!", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
		Label14:
			if (checked2)
			{
